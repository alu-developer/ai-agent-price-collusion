...
Die Forschungsfrage haben Alois Lux und Claude gemeinsam bei Apart Researchs ["AI Collusion Research Sprint"](https://apartresearch.com/sprints/ai-collusion-research-sprint-2026-10-23-to-2026-10-25) (23.–25.10.2026) gefunden — dieses Projekt ist eigenständige Arbeit zu der dort gestellten Frage, keine offizielle Einreichung beim Sprint. Alle Design-Entscheidungen (inkl. Budget- und Konfigurationsänderungen während der Studie) hat Alois Lux getroffen und das finale Paper geprüft und freigegeben. Claude (Anthropic) hat als Coding-Agent unter seiner Anleitung den Code implementiert, die Studie ausgeführt, die statistische Auswertung und Verifikation gegen die Rohdaten durchgeführt und den Paper-Text entworfen — Alois Lux hat nicht jede einzelne Zeile der Rohdaten selbst nachgeprüft. Details im Abschnitt "Author Contributions and AI-Assistance Disclosure" in [paper/paper.pdf](paper/paper.pdf).
